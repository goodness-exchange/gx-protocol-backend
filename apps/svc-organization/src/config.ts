...
export type OrganizationConfig = z.infer<typeof configSchema>;

export const organizationConfig: OrganizationConfig = configSchema.parse({
  port: process.env.ORGANIZATION_SERVICE_PORT || process.env.PORT || 3003,

...
export type LoanPoolConfig = z.infer<typeof configSchema>;

export const loanPoolConfig: LoanPoolConfig = configSchema.parse({
  port: process.env.LOANPOOL_SERVICE_PORT || process.env.PORT || 3004,
